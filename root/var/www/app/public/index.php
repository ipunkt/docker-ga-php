 ...
 *
 * Parameter:
 * utmac: GA-Account-Id - wenn es fehlt wird DEFAULT_GA_ACCOUNT genutzt
 * utmp: Tracking-Pfad
 * utmr: Referrer, defaults to "-"
 *
 * utmdebug: Debugausgabe, im Header
 *
 **/
...
$cookieName = getenv( 'COOKIE_PATH' );
if($cookieName === false)
	$cookieName = '__utmmobile';
...
define("DEFAULT_GA_ACCOUNT", getenv('DEFAULT_GA_ACCOUNT'));
...
function trackPageView() {
    ...
    $account = isset($_GET["utmac"]) ? $_GET['utmac'] : DEFAULT_GA_ACCOUNT;
    ...
    $utmUrl = $utmGifLocation . "?" .
        ...
        "&utmac=" . $account .
        "&utmcc=__utma%3D" . rand(1000000000, 2147483647) . "." .
        time() . "." . time() . "." .
        time() . "." . time() . ".1%3B".
        "&utmvid=" . $visitorId .
